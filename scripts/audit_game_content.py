...
def normalize_title(value):
    ...
    text = re.sub(r"\b(part|часть|серии?|эпизод|ep|e|s)\b", " ", text)
...
def main():
    ...
    for card in type_cards:
        ...
        card_title = clean(card.get("card_title"))
    ...
    print("SAME_CONTENT_ID_IN_MULTIPLE_MANUAL_GAME_CARDS")
    print(len(multi_type_cards))
    for content_id, values in multi_type_cards.items():
        print(content_id, values)
    print()

    print("GAME_ITEMS_LINKED_ONLY_TO_NON_GAME_CARDS")
