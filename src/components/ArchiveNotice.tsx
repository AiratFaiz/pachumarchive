    ...
    <div ref={wrapperRef} className="relative h-10 w-10 shrink-0">
      ...
      {isOpen && (
        ...
        >
          ...
          <p>
            Идея архива — собрать весь контент Пачума в одном месте для
            удобного поиска и навигации.
          </p>

          <p className="mt-3">
            Архив ещё в работе. Фильмы, сериалы, игры и аниме приведены в порядок.
            Фильтры могут работать не совсем корректно.
          </p>
